...
public class AntiSamyPolicyTest {
    ...
    public static void setup() throws InvalidConfigException, XMLStreamException, IOException {
        antiSamy = new HtmlSanitizer(
                new AntiSamyPolicy(AntiSamyPolicyTest.class.getClassLoader().getResourceAsStream(POLICY_FILE)));
    }
    ...
    static TestInput[] dataForScriptFiltering() {
        return new TestInput[] {
            ...
            new TestInput(
                    "<![CDATA[]><script>alert(1)</script><![CDATA[]>]]><script>alert(2)</script>>]]>",
                    "<script",
                    false),
        };
    }
    ...
    static TestInput[] dataForURIFiltering() {
        return new TestInput[] {
            ...
            new TestInput(
                    ...
                    Pattern.compile("<div(\\s+style=\"\")?(\\s*/)?>"),
                    true,
                    true),
            new TestInput(
                    "<a href='aim: &c:\\windows\\system32\\calc.exe' ini='C:\\Documents and Settings\\All Users\\Start "
                            + "Menu\\Programs\\Startup\\pwnd.bat'>",
                    "calc.exe",
                    false),
            ...
            new TestInput(
                    ...
                    "http://subdomain" + ".domain/(S(ke0lpq54bw0fvp53a10e1a45))/MyPage.aspx",
                    true),
    ...
    static TestInput[] dataForCSSFiltering() {
        return new TestInput[] {
            new TestInput(
                    "<p style=\"border-color: transparent\"> Border Color </p>", "border-color: transparent", true),
            ...
            new TestInput(
                    "<p style=\"background-color: black\"> Background Color </p>", "background-color: black", true),
            ...
            new TestInput(
                    ...
                    true),
            new TestInput(
                    "<style type=\"text/css\"><![CDATA[P { margin-bottom: 0.08in; } ]]></style>",
                    "margin-bottom",
                    true),
            new TestInput(
    ...
    static TestInput[] dataForIssueSLING8771() {
        return new TestInput[] {
            new TestInput(
                    "<figure class=\"image\"><img src=\"/logo.jpg\"><figcaption>Caption Here</figcaption></figure>",
                    "<figure",
                    true),
            new TestInput(
                    "<figure class=\"image\"><img src=\"/logo.jpg\"><figcaption>Caption Here</figcaption></figure>",
