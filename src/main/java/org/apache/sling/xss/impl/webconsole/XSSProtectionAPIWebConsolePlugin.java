...
public class XSSProtectionAPIWebConsolePlugin extends HttpServlet {
    ...
    */
    ...
    private static final Set<String> CSS_RESOURCES =
            new HashSet<>(Arrays.asList(RES_URI_PRETTIFY_CSS, RES_URI_XSS_CSS));
    private static final Set<String> JS_RESOURCES =
            new HashSet<>(Arrays.asList(RES_URI_PRETTIFY_JS, RES_URI_XSS_JS, RES_URI_BLOCKED_JS, RES_URI_CONFIG_JS));
